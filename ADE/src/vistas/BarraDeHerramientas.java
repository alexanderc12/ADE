...
public class BarraDeHerramientas extends JToolBar {
	...
	public BarraDeHerramientas(Controlador controlador) {
		...
		btnBuscarEnListas = new JButton(createImageIcon(ConstantesGUI.ICONO_BUSCAR_EN_LISTAS));
		btnBuscarEnListas.setFocusable(false);
		btnBuscarEnListas.setToolTipText(ConstantesGUI.T_ITEM_BUSCAR_EN_LISTAS);
